...
function momentous_customize_controls_js() {
	...
	wp_localize_script( 'momentous-lite-customizer-controls', 'momentous_theme_links', array(
		...
		'themeURL'	=> esc_url( 'https://themezee.com/themes/momentous/?utm_source=customizer&utm_medium=textlink&utm_campaign=momentous&utm_content=theme-page' ),
		'themeLabel'	=> esc_html__( 'Theme Page', 'momentous-lite' ),
		'docuURL'	=> esc_url( 'https://themezee.com/docs/momentous-documentation/?utm_source=customizer&utm_medium=textlink&utm_campaign=momentous&utm_content=documentation' ),
